...
P2.add(adminButton);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            ...
            pa1.setEchoChar(c1.isSelected() ? (char) 0 : '*');
